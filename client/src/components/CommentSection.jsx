    ...
    <div className='max-w-2xl mx-auto w-full p-3'>
      ...
      (
        <div className='flex item-center gap-1 my-5 text-gray-500 text-sm'>
          <p>Signed in as:</p>
          <img className='h-5 w-5 object-cover rounded-full mt-0.5' src={currentUser.profilePicture} alt=""/>
          <Link  className='text-xs text-cyan-600 hover:underline mt-1' to={'/dashboard?tab=profile'}>
